...
def check_tarball_out(ipppssoot, input_uri, output_uri):
    ...
    if output_uri.startswith("file"):
        ...
        preview_path = os.path.abspath(os.path.join(output_path, "previews"))
        env_path = os.path.abspath(os.path.join(output_path, "env"))
        for f in os.listdir(log_path):
            file_list.append(os.path.join(log_path, f))
        for f in os.listdir(preview_path):
            file_list.append(os.path.join(preview_path, f))
        for f in os.listdir(env_path):
            file_list.append(os.path.join(env_path, f))
